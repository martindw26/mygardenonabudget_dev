    ...
    if (is_array($category_ids)) {
        foreach ($category_ids as $term_id) {
            ...
            if (is_a($term, 'WP_Term') && !is_wp_error($term)) {
                ...
                error_log('Invalid term ID: ' . $term_id); // Log invalid term IDs
            }
        }
    }
...
var_dump($sidebar_bottom_categories); // Debug check
...
<div class="sidebar">
    ...
    if ($related_posts_bottom->have_posts()) :
        echo 'Posts found: ' . $related_posts_bottom->found_posts; // Debug check
    ...
    <?php
        ...
        echo 'No posts found for these categories.'; // Debug message
    endif;
    ?>
</div>
